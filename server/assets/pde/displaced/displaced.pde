...
/* @pjs preload="/assets/pde/displaced/displaced0.jpg,/assets/pde/displaced/displaced1.jpg"; */
...
void setup() {
    ...
    BACKGROUND_IMAGES[0] = path + "displaced0.jpg";
    BACKGROUND_IMAGES[1] = path + "displaced1.jpg";
