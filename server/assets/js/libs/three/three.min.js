...
/**
 * @author fisch0920 / www.transitivebullshit.com
 */

THREE.PJSTexture = function ( pjsURL, width, height, format, type, mapping, wrapS, wrapT, magFilter, minFilter, anisotropy ) {
    ...
    var src = getURL(pjsURL);
    this.pjsURL = pjsURL;
    this.pjs = new Processing(this.canvas, src);
    this.pjs.noLoop();
    this.pjs.redraw();
...
THREE.PJSTexture.prototype = Object.create( THREE.Texture.prototype );

THREE.PJSTexture.prototype.clone = function () {

	var texture = new THREE.PJSTexture(this.pjsURL, this.width, this.height);
