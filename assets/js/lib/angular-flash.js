...
(function () {
  ...
  function flashAlertDirective(flash, $timeout, $rootScope) {
    return {
      scope: true,
      link: function ($scope, element, attr) {
        ...
        function show(message, type) {
          ...
          var delay = Number(attr.duration || (type === 'error' ? 8000 : 5000));
          if (delay > 0) {
  ...
  angular.module('angular-flash.flash-alert-directive', ['angular-flash.service'])
    .directive('flashAlert', ['flash', '$timeout', '$rootScope', flashAlertDirective]);
